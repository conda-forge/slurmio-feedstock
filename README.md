...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/slurmio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15240&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/slurmio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `slurmio` can be installed with:

```
conda install slurmio
```

It is possible to list all of the versions of `slurmio` available on your platform with:
